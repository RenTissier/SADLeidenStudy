...
Phenotypes<-c("R_superiorfrontal_surfavg", "L_superiorfrontal_surfavg","R_caudalmiddlefrontal_surfavg","L_caudalmiddlefrontal_surfavg","R_rostralmiddlefrontal_surfavg", "L_rostralmiddlefrontal_surfavg", "R_lateralorbitofrontal_surfavg", "L_lateralorbitofrontal_surfavg", 
              "R_medialorbitofrontal_surfavg", "L_medialorbitofrontal_surfavg", "R_precentral_surfavg", "L_precentral_surfavg", "R_caudalanteriorcingulate_surfavg", "L_caudalanteriorcingulate_surfavg", 
              "R_rostralanteriorcingulate_surfavg", "L_rostralanteriorcingulate_surfavg", "R_insula_surfavg", "L_insula_surfavg", "R_superiorparietal_surfavg", "L_superiorparietal_surfavg", 
              "R_inferiorparietal_surfavg","L_inferiorparietal_surfavg", "R_precuneus_surfavg", "L_precuneus_surfavg", "R_supramarginal_surfavg", "L_supramarginal_surfavg", "R_postcentral_surfavg", "L_postcentral_surfavg",
              "R_temporalpole_surfavg", "L_temporalpole_surfavg",  "R_inferiortemporal_surfavg", "L_inferiortemporal_surfavg", "R_superiortemporal_surfavg", "L_superiortemporal_surfavg","R_fusiform_surfavg", "L_fusiform_surfavg", 
              "R_transversetemporal_surfavg", "L_transversetemporal_surfavg") # input all secondary phenotypes here 

#######Example with xx as secondary phenotype and Age and Sex and ICV as covariates, SAD_d as primary phenoty
results_surfacearea<-LikelihoodOptimization(dataset,primaryPhenotype=c("SAD_d"),secondaryPhenotype=Phenotypes[m],covariates=c("Age_demeaned", "Sex", "TotalGlobalSurfArea_div1000_demeaned"),index=c(2,3,5,4,7),seed=236)
