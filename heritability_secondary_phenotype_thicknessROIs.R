...
CatalanoLikelihood<-function(dataset,VarX,VarY,covYX,sizeFamily){
  ...
  prob<-dmvnorm(dataset$secondary,mean=dataset$meanX,sigma=VarX)*pmvnorm(lower,upper,mean=meanYgivenX,sigma=VarYgivenX,algorithm=GenzBretz(maxpts = 30000000,abseps =0.0000001))#Obtention of the loglikelihood for the family by summing log(P(X|G))+log(P(Y|G,X)))
  prob
}
...
denominatorBis<-function(dataset,VarY,sizeFamily){
  ...
  ProbY<-pmvnorm(lower,upper,mean=dataset$meanY,sigma=VarY,algorithm=GenzBretz(maxpts = 30000000,abseps =0.0000001)) #computing the marginal probability of Y given the genotypes
  ProbY
}
?pmvnorm
...
Phenotypes<-c("R_superiorfrontal_thickavg", "L_superiorfrontal_thickavg","R_caudalmiddlefrontal_thickavg","L_caudalmiddlefrontal_thickavg","R_rostralmiddlefrontal_thickavg", "L_rostralmiddlefrontal_thickavg", "R_lateralorbitofrontal_thickavg", "L_lateralorbitofrontal_thickavg", 
              "R_medialorbitofrontal_thickavg", "L_medialorbitofrontal_thickavg", "R_precentral_thickavg", "L_precentral_thickavg", "R_caudalanteriorcingulate_thickavg", "L_caudalanteriorcingulate_thickavg", 
              "R_rostralanteriorcingulate_thickavg", "L_rostralanteriorcingulate_thickavg", "R_insula_thickavg", "L_insula_thickavg", "R_superiorparietal_thickavg", "L_superiorparietal_thickavg", 
              "R_inferiorparietal_thickavg","L_inferiorparietal_thickavg", "R_precuneus_thickavg", "L_precuneus_thickavg", "R_supramarginal_thickavg", "L_supramarginal_thickavg", "R_postcentral_thickavg", "L_postcentral_thickavg",
              "R_temporalpole_thickavg", "L_temporalpole_thickavg",  "R_inferiortemporal_thickavg", "L_inferiortemporal_thickavg", "R_superiortemporal_thickavg", "L_superiortemporal_thickavg","R_fusiform_thickavg", "L_fusiform_thickavg", 
              "R_transversetemporal_thickavg", "L_transversetemporal_thickavg") # input all secondary phenotypes here 

########Example with xx as secondary phenotype and Age and Sex and ICV as covariates, SAD_d as primary phenoty
results_corticalthickness<-LikelihoodOptimization(dataset,primaryPhenotype=c("SAD_d"),secondaryPhenotype=Phenotypes[m],covariates=c("Age_demeaned", "Sex",  "GlobalMeanThickness_demeaned"),index=c(2,3,5,4,7),seed=150)
